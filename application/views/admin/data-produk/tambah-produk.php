  ...
  <div class="col-xl-12 mb-3">
	<div class="card">
					...
					<div class="card-body">
						<h5>Tambah Produk</h5>
						<hr>
						<form action="<?= base_url('manage/data-produk/tambah') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
							<div class="form-group">
								<label for="nama">Nama Produk</label>
								<input type="text" name="nama_produk" value="<?php echo set_value('nama_produk') ?>" class="form-control" placeholder="Masukan Nama Produk">
							...
							<div class="form-group">
								...
								<input type="text" name="harga" value="<?php echo set_value('harga') ?>" class="form-control" placeholder="Masukan Harga Produk">
							...
							<div class="form-group">
								...
								<textarea class="form-control" rows="5" id="editor1" name="keterangan_produk"><?php echo set_value('keterangan_produk') ?></textarea>
							...
							<div class="form-group">
								...
								<input type="text" name="berat" value="<?php echo set_value('berat') ?>" class="form-control" placeholder="Contoh : 3, 7, 10, dan seterusnya">
